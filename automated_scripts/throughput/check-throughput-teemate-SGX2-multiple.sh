...
do
    ...
    wsk action create gramine --docker jakdurider/teemate_throughput_image $i -m 128 -t 3000000
    ...
    docker unpause wsk0_4_guest_gramine
    docker unpause wsk0_5_guest_gramine
    docker unpause wsk0_6_guest_gramine
